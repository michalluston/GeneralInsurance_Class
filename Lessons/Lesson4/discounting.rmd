...
```{r}
#prvé su dáta z "lesson2", ale nepoužili sme Large data:
...
#mam prehodene stlpce, tak podla nahovu ich prehodim, tak aby bol prvy na mieste
...
#teraz este pre dalsie data z inych suborov:
Paid_3rd_sml <- dt_PaidCase %>% filter(Business == "3rd Party" & ClaimSize == "Small" & dataset_type == "PAID")
Paid_3rd_sml_triangle <- Paid_3rd_sml %>% as.triangle(origin = "ay", dev = "dy", "SumOfamount") 
...
Paid_3rd_lrg_triangle <- Paid_3rd_lrg %>% as.triangle(origin = "ay", dev = "dy", "SumOfamount")
...
PC_HH_Large<-dt_PaidCase %>% filter( Business == "House" & ClaimSize == "Large" )  
PC_HH_Large_triangle <- PC_HH_Large %>% as.triangle(origin = "ay", dev = "dy", "SumOfamount")
PC_HH_Large_triangle
PC_HH_Large_triangle <- triangle(PC_HH_Large_triangle[,10], PC_HH_Large_triangle[,9], PC_HH_Large_triangle[,1], PC_HH_Large_triangle[,2], PC_HH_Large_triangle[,3], PC_HH_Large_triangle[,4], PC_HH_Large_triangle[,5], PC_HH_Large_triangle[,6], PC_HH_Large_triangle[,7], PC_HH_Large_triangle[,8])
PC_HH_Large_triangle
...
PC_HH_Small_triangle <- triangle(PC_HH_Small_triangle[,10], PC_HH_Small_triangle[,9], PC_HH_Small_triangle[,1], PC_HH_Small_triangle[,2], PC_HH_Small_triangle[,3], PC_HH_Small_triangle[,4], PC_HH_Small_triangle[,5], PC_HH_Small_triangle[,6], PC_HH_Small_triangle[,7], PC_HH_Small_triangle[,8])
PC_HH_Small_triangle
...
PC_3rd_Large_triangle <- triangle(PC_3rd_Large_triangle[,10], PC_3rd_Large_triangle[,9], PC_3rd_Large_triangle[,1], PC_3rd_Large_triangle[,2], PC_3rd_Large_triangle[,3], PC_3rd_Large_triangle[,4], PC_3rd_Large_triangle[,5], PC_3rd_Large_triangle[,6], PC_3rd_Large_triangle[,7], PC_3rd_Large_triangle[,8])
PC_3rd_Large_triangle
...
PC_3rd_Small_triangle <- triangle(PC_3rd_Small_triangle[,10], PC_3rd_Small_triangle[,9], PC_3rd_Small_triangle[,1], PC_3rd_Small_triangle[,2], PC_3rd_Small_triangle[,3], PC_3rd_Small_triangle[,4], PC_3rd_Small_triangle[,5], PC_3rd_Small_triangle[,6], PC_3rd_Small_triangle[,7], PC_3rd_Small_triangle[,8])
PC_3rd_Small_triangle
plot(PC_HH_Small_triangle)
